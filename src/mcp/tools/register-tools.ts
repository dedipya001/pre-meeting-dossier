...
export function registerTools(server: McpServer, services: {
  ...
  server.registerTool("get_event_context", {
    ...
    const parsed = GetEventContextInputSchema.parse(input);
    return jsonContent(await services.meetingResolver.getEventContext(parsed.eventId));
  });
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchPeople(SearchPeopleInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchOrganizations(SearchOrganizationsInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchConversations(SearchConversationsInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchDocuments(SearchDocumentsInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchBusinessRecords(SearchBusinessRecordsInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchActivity(SearchActivityInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.contextSearch.searchOpenItems(SearchOpenItemsInputSchema.parse(input))));
  ...
  }, async (input) => jsonContent(await services.recentChanges.getRecentChanges(GetRecentChangesInputSchema.parse(input))));
}
